...
class _SignUpPageState extends State<SignUpPage> {
  ...
  String? userType; // New variable to store the user type selection
  ...
  // New Method: Display user type selection screen
  ...
  Widget _buildSignUpForm() {
    return Column(
      children: [
        ...
        const SpaceVH(height: 20.0),
        // Height and Weight fields (only if the user is an athlete)
        if (userType == 'athlete') ...[
          textField(
  ...
  void _signUp() async {
    try {
      ...
      int? height =
          userType == 'athlete' ? int.tryParse(userHeight.text) : null;
      int? weight =
          userType == 'athlete' ? int.tryParse(userWeight.text) : null;
